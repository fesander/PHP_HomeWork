...
--
-- Хост: 127.0.0.1:3307
-- Время создания: Мар 18 2019 г., 23:11
...
(0, 'Стефан', 21588, 'chair_1.jpg', 1),
(1, 'Ингольф', 30836, 'chair_2.jpg', 2),
(2, 'Терье', 28474, 'chair_3.jpg', 3),
(3, 'Каустби', 6958, 'chair_4.jpg', 4),
(4, 'Хенриксдаль', 7846, 'chair_5.jpg', 5);
...
(24, 'Василий', 'На фото камод с шестью ящиками, из них два верхних маленькие. Все они с направляющими. А в реалии в двух верхних ящиках вместо направляющих прибиты дощечки-по старинке. И в описании направляющие не предусмотрены. В общем не подкапаешся, а камод нужен был. Пришлось докупать недостающий элемент и дорабатывать самому. Из-за такого кидалова \r\nодин негатив. ');
