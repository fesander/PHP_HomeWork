...
$tpl = file_get_contents('../view/templates/cart.tpl');
...
if (isset($_SESSION[login]) && isset($_SESSION[pass])) {
    ...
    foreach($goods as $good) {
        ...
        $goodItems .="<td><div class='minus' onclick=\"decreaseGood(" . $good['id'] . ")\">-</div>";
        $goodItems .="<span id='goodsCount" . $good['id'] . "'>".$good['count']."</span>";
        $goodItems .="<div class='plus' onclick=\"increaseGood(" . $good['id'] . ")\">+</div></td>";
