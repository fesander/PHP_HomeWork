...
$patterns = array( '/{title}/', '/{bigImage}/', '/{name}/','/{short}/', '/{care}/', '/{size}/', '/{price}/', '/{views}/', '/{id}/' );
$replace = array( $title, $bigImage, $chairName, $chairDesc, $chairCare, $chairSize, $chairPrice, $currentViewNumber, $chairId );
